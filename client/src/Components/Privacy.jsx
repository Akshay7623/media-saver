            ...
            <div className='px-5'>
                <div className="privacy-policy">
                    ...
                    <ul className="list-disc pl-6">
                        <li>
                            <Typography variant="paragraph">
                                <b>Account:</b> A unique account created for You to access our Service or parts of our Service.
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                                <b>Affiliate:</b> An entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest, or other securities entitled to vote for election of directors or other managing authority.
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                                <b>Company:</b> (referred to as either "the Company", "We", "Us", or "Our" in this Agreement) refers to [website link].
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                                <b>Cookies:</b> Small files placed on Your computer, mobile device, or any other device by a website, containing details of Your browsing history on that website among its many uses.
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                                <b>Country:</b> Refers to Australian Capital Territory, Australia.
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                                <b>Device:</b> Any device that can access the Service, such as a computer, a cellphone, or a digital tablet.
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                        ...
                        <li>
                            <Typography variant="paragraph">
                                <b>Usage Data:</b> Data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (e.g., the duration of a page visit).
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                                <b>Website</b> refers to [website link], accessible from [website link]
                            </Typography>
                        </li>
                        <li>
                            <Typography variant="paragraph">
                                <b>You</b> You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
                            </Typography>
                        </li>
                    ...
                    <ul className="list-disc pl-6">
                        <li>
                            <Typography variant="paragraph">Usage Data</Typography>
                        </li>
                    </ul>
                    ...
                    <Typography variant="paragraph">
                        We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used include beacons, tags, and scripts to collect and track information and improve Our Service. The technologies We use may include:
                    </Typography>
                    ...
                    <ul className="list-disc pl-6 my-5">
                        ...
                        <li>
                            <Typography className='my-2' variant="paragraph">
                                <b>To provide You with news, </b> special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.
                            </Typography>
                        </li>
                        <li>
                            <Typography className='my-2' variant="paragraph">
                    ...
                    <Typography className='my-4' variant='paragraph'>We may share Your personal information in the following situations:</Typography>
                    ...
                    <ul className="list-disc pl-6 my-5">
                        ...
                        <li>
                            <Typography className='my-2' variant="paragraph">
                                <b>With business partners:</b>We may share Your information with Our business partners to offer You certain products, services or promotionGs.
                            </Typography>
                        </li>
                    ...
                    <Typography className='my-2' variant="paragraph">
                        If you have any questions about this Privacy Policy, You can contact us: <Link className='text-blue-800' to='/contact'>here</Link>
                    </Typography>
